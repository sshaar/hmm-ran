...
class GenreFeatureData:
    ...
    # dir_trainfolder = "/home/sabith/hmm-rnn/data/genres"
    # dir_devfolder = "/home/sabith/hmm-rnn/data/genres"
    # dir_testfolder = "./gtzan/_test"
    dir_all_files = "/home/sabith/hmm-rnn/data/genres/classical"
    ...
    def load_preprocess_data(self):
        self.trainfiles_list = self.path_to_audiofiles(self.dir_all_files, 1)
        self.devfiles_list = self.path_to_audiofiles(self.dir_all_files, 2)
        self.testfiles_list = self.path_to_audiofiles(self.dir_all_files, 3)
